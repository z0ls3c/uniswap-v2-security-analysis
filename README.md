...
- [Uniswap V2 Security Analysis](#uniswap-v2-security-analysis)
  - [Table of Contents](#table-of-contents)
  - [What is Uniswap?](#what-is-uniswap)
    - [How Users Interact with Uniswap?](#how-users-interact-with-uniswap)
  - [Core Concepts](#core-concepts)
    - [The Constant Product Formula $\\large{(x \\times y = k)}$](#the-constant-product-formula-largex-times-y--k)
    ...
    - [Trading Fees (In Detail)](#trading-fees-in-detail)
...
![Seesaw](./diagrams/visualpool.png)
...
This analysis includes Foundry tests demonstrating core mechanics on mainnet fork:

- **Swap Execution** - ETH → USDC via Router
- **Liquidity Provision** - Add ETH/USDC liquidity
- **Liquidity Removal** - Withdraw liquidity by burning LP tokens

See [test/README.md](test/README.md) for setup and execution instructions.

**Security pattern tests** ($\large k$ invariant attacks, donation scenarios, reentrancy, weird tokens) are planned for a future update.
